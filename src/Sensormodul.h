...
#define MAIN_ParameterSize 14704
#define MAIN_MaxKoNumber 1216
...
#define WIRE_KoCalcIndex(number) ((number >= WIRE_KoCalcNumber(0) && number < WIRE_KoCalcNumber(WIRE_KoBlockSize)) ? (number - WIRE_KoOffset) % WIRE_KoBlockSize : -1)
